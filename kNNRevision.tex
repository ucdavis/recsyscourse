...
We find the users in our existing data D who are most similar to N and who
...
The first is basically \textit{k-Nearest Neighbor regression}, a
...
latter, we create a collection of sets of rectangles and average over
